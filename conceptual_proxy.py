...
SAMPLES = {
    ...
    "suno_extraction": {
        ...
        "description": "A Haskell script that extracts a token from a Suno URL.",
        "language": "haskell"
    },
    "swatch_temporal": {
        "file": "static/Empire/Silicium/SwatchTemporal.hs",
        "description": "A Haskell script that defines a conceptual temporal swatch with state transitions based on entropy.",
        "language": "haskell"
    },
    "tempo_universal": {
