...
function Watchdog-Epistemico {
    ...
    # Monitorar consumo de recursos como "evidência empírica" (Apenas no Windows)
    if ($IsWindows) {
...
"@
    ...
    $caminhoSigilo = "$env:TEMP\AutoEutanasia_Sigilo_Final.txt"
