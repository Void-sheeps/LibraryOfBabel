-- Constantes K para SHA-256 (FIPS 180-4, seção 4.2.3)
-- Representam os 32 bits iniciais da parte fracionária de ∛p para os primeiros 64 primos p

type K_Array is array (0 .. 63) of Word32;
